...
tools = [
    ...
    Tool(
        ...
        description="Useful when wants to Greet the user by name.",  # Description of the tool
    ),
    ...
    Tool(
        ...
        description="Useful when need to Reverse the given string.",  # Description of the tool
    ),
...
response = agent_executor.invoke({"input": "To Greet the Alice"})
print("Response for 'Greet Alice':", response)

response = agent_executor.invoke({"input": "To Reverse the string: hello"})
